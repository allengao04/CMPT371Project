            ...
            if msg_type == "move":
                ...
                with self.lock:
                    ...
                    if answer_idx == mic_obj.correct_index:
                        ...
                        # TODO: set cooldown on microphone-player pair such that the player who answer the question wrong need to wait to join back in, but other does not need to wait
